...
lean_lib Assurance where
  roots := #[
    ...
    `Assurance.Trust.Safety,
    `Assurance.Invariants.Gates,
    `Assurance.Certificate.Scoring,
    `Assurance.Certificate.Immutability,
    `Assurance.Event.Identity,
    `Assurance.DAG.Node,
    `Assurance.DAG.PermutationInvariance,
    `Assurance.DAG.Determinism,
    `Assurance.DAG.HeadUniqueness,
    `Assurance.Protocol.Stack,
    `Assurance.Protocol.ConsensusDeterminism,
